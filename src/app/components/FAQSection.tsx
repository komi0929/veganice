...
const faqs = [
  ...
  {
    q: "夏以外にクラフトアイスは売れますか？",
    a: "はい、通年で売れます。薬院のお店では冬場でもデザートの注文率はほぼ変わりません。和食コースの口直し、ディナーの〆、バレンタイン・クリスマスなど特別な日のデザートとして、季節に合ったフレーバー（秋のほうじ茶、冬の甘酒抹茶など）を提案することで、むしろ「特別感」が増します。",
  },
  {
  ...
  {
    q: "初めての導入でも安心ですか？",
    a: "はい。最小4Lからお試しいただけます。冷凍保存で廃棄ロスもなく、初期投資もかかりません。まずは1回、お客様の反応を見てみてください。",
  },
];
