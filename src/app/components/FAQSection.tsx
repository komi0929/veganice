...
const faqs = [
  ...
  {
    q: "夏以外にアイスは売れますか？",
    a: "はい、通年で売れます。直営店では冬場でもデザートの注文率はほぼ変わりません。和食コースの口直し、ディナーの〆、バレンタイン・クリスマスなど特別な日のデザートとして、季節に合ったフレーバー（秋のほうじ茶、冬の濃厚抹茶など）を提案することで、むしろ「特別感」が増します。",
  },
  {
    q: "メニューにはどう記載すればいいですか？",
    a: "たとえば「クラフトヴィーガンジェラート（乳・卵・小麦不使用）¥○○○」のように、アレルギー対応であることを明記するのがおすすめです。「プラントベース」「米粉ジェラート」といった表現も効果的です。導入店舗様にはメニュー記載例のテンプレートもご提供しています。",
  },
  {
    q: "お客様にどう説明すればいいですか？",
    a: "「植物性の素材だけで作った、濃厚な手づくりジェラートです。乳製品・卵・小麦を使っていないので、アレルギーの方も安心してお召し上がりいただけます」——これだけで十分です。「ヴィーガン」という言葉に馴染みのないお客様には「植物性」「プラントベース」がおすすめです。",
  },
  {
    q: "導入して売れなかった場合のリスクは？",
